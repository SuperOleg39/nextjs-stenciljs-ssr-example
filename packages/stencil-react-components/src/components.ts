...
import type { JSX } from 'stencil-web-components';

import { defineCustomElements } from 'stencil-web-components/loader';

defineCustomElements();
export const ChildComponent = /*@__PURE__*/createReactComponent<JSX.ChildComponent, HTMLChildComponentElement>('child-component');
